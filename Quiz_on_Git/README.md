...
only A.txt , and B.txt since .gitgnore is hidden
...
1. git checkout experiment : we will go to repository at C4
2. git rebase master : C4 will join with the Master Branch, head on C5 in the master branch
3. git checkout master : we will go to master branch and head will be on c5
4. git merge experiment :nothing will happen
...
yes since everything is uptodate
